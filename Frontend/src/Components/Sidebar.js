...
const Sidebar = ({ sideOpen }) => {
    ...
    const [showLogoutMenu, setShowLogoutMenu] = useState(false); // NEW STATE
        ...
        <div className="smiels-sidebar " id="sidebar">
            <div
                ...
                <footer className="footer">
                    <div className="smiles-user flex items-center justify-between mb-5 relative" id="close">
                        ...
                        {/* LOGOUT MENU - SHOWS ON CLICK */}
                        {showLogoutMenu && (
                            <div className="dropdown-menu-2 w-40 flex flex-col absolute right-0 -top-16
                             bg-dashboard border border-searchIcon rounded shadow-lg z-50" id="dropdown-menu-2">
                                <ul className="setting-menu flex items-center flex-col" >
                                    <li className='list-none w-full hover:bg-searchIcon ' >
                                        <Link 
                                            to={`team/view/${user?._id}`} 
                                            className="setting-link flex gap-2.5 items-center p-2.5 text-xs border-b border-dashbaord decoration-0 text-black "
                                    ...
                                    <li className='list-none w-full hover:bg-searchIcon ' >
                                        <span 
                                            className="setting-link flex gap-2.5 items-center p-2.5 text-xs decoration-0 text-black cursor-pointer"
                                            onClick={() => {
                                                handleLogout();
