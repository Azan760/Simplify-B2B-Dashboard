          ...
          filteredData?.map((field) => (
            <tr key={field._id} className='  hover:bg-searchIcon border border-b-1 border-b-searchIcon '>
              ...
              <td className='p-2 font-medium text-white  '>
                <span className=' p-1 text-xs rounded md:p-1 md:px-0  block text-center  bg-heading' >
                {field?.details?.type}
                </span>
                </td>
              ...
              <td className='p-3 font-medium text-textColor2 text-xs'>{field.details["brand"]}</td>
              <td className='p-3 font-medium text-textColor2 text-xs'>{field.details["category"]}</td>
              <td className='p-3 font-medium text-textColor2 text-xs'>{field.details["subCategory"]}</td>
              <td className='p-3 font-medium text-textColor2 text-xs'>{field.details["purchaseCost"]}</td>
              <td className='p-3 font-medium text-textColor2 text-xs'>{field.details["salePrice"]}</td>
